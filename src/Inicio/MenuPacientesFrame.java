 ...
 * List<NotificacionDAO.Notificacion> lista =
 * NotificacionDAO.obtenerNotificaciones(idPaciente);
 * 
 * if (lista.isEmpty()) {
 * JOptionPane.showMessageDialog(
 * this,
 ...
 * new GestionEnfermedades.VerDatosPaciente(idPaciente).setVisible(true);
 * dispose();
 * });
 ...
 * new
 * MisJustificantesPacienteFrame(String.valueOf(idPaciente)).setVisible(true);
 * dispose();
 * });
